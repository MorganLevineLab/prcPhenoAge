#' @title PRC PhenoAge Weights
#'
#' @description The regression values to calculate the PRC-associated subscore of PhenoAge
#'
...
#'   \item{PRC:}{Confirmation that the CpG is PRC associated}
#' }
